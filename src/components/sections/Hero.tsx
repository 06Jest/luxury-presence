...
export function Hero() {
  ...
  return (
    <section ref={rootRef} id="top" className="relative isolate min-h-[92svh] overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div data-hero-image className="relative h-full w-full will-change-transform">
          <Image
      ...
      <Container className="flex min-h-[92svh] flex-col justify-end pb-16 pt-32 sm:pb-24 lg:pb-28">
        <div className="max-w-3xl text-sand-50">
          <p data-hero-fade className="eyebrow text-sand-50/80">
          ...
          >
            {site.experience}, helping buyers and sellers across the valley. We live, work,
            and play in this community.
          </p>

          <div data-hero-fade className="mt-10 flex flex-wrap items-center gap-4">
            <ButtonLink href="#search">Find a home</ButtonLink>
            <a
